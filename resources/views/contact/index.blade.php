...
<head>
    ...
    <title>Contact Us | Skyline</title>
    <meta name="description"
        content="Get in touch with Skyline, Nepal's premier manpower agency for overseas recruitment. Contact our Kathmandu office today.">
    <!-- Google Fonts -->
...
<body>
    ...
    <section class="page-header">
        <div class="container fade-in-up">
            ...
            <p class="page-subtitle">Visit our Kathmandu office or reach out to our team online. We're here to assist
        ...
        <div class="container">
            <div class="contact-grid">
                ...
                <div class="contact-info fade-in-up">
                    <h3>Head Office (Nepal)</h3>
                    <div class="info-item">
                        <i class="fa-solid fa-location-dot info-icon"></i>
                        <div class="info-text">
                            <h4>Physical Address</h4>
                            <p>Manpower Building, Baneshwor<br>Kathmandu, Bagmati Province<br>Nepal</p>
                        </div>
                    </div>
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            <h4>Phone Number</h4>
                            <p>Desk: +977-1-4XXXXXX<br>Mobile/WhatsApp: +977-980XXXXXXX</p>
                        </div>
                    </div>
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            <h4>Email Address</h4>
                            <p>Information: info@skyline.com.np<br>Client Demands: cvs@skyline.com.np</p>
                        </div>
                    </div>

                    <div class="social-links mt-4" style="margin-top: 3rem;">
                ...
                <!-- Contact Form -->
                <div class="contact-form-wrapper fade-in-up delay-100">
                    <form class="contact-form"
                        onsubmit="event.preventDefault(); alert('Message sent successfully! Our Kathmandu desk will contact you soon.');">
                        <h3>Send your Inquiry</h3>
                        <p>Fill out the form below block, and we will get back to you within 24 working hours.</p>

                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label" for="firstName">First Name</label>
                                <input type="text" id="firstName" class="form-control" placeholder="Ram" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="lastName">Last Name</label>
                                <input type="text" id="lastName" class="form-control" placeholder="Bahadur" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" id="phone" class="form-control" placeholder="+977-9800000000">
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 1.5rem;">
                            ...
                            <input type="text" id="subject" class="form-control"
                                placeholder="Visa Query, Interview Schedule, etc." required>
                        </div>

                        <div class="form-group" style="margin-bottom: 2rem;">
                            <label class="form-label" for="message">Message</label>
                            <textarea id="message" class="form-control" placeholder="How can we assist you today?"
                                required></textarea>
                        </div>

                        <button type="submit" class="btn btn-primary btn-large" style="width: 100%;">Send Message <i
